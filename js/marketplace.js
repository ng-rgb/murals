...
const Toast = Swal.mixin({
  ...
  function renderInventory(NFTs){
    ...
    <div class="box">
      ...
      <img class="box__img" src="${nft.metadata.image}" alt="Some image"/>
      <h3 class="box__title"><span class="box__title-inner" data-hover="${nft.metadata.name}">${nft.metadata.name}</span></h3>
      <h4 class="box__text"><span class="box__text-inner">${nft.token_id}</span></h4>
      <div class="box__deco">&#10032;</div>
      <p class="box__content">${nft.metadata.description} <br>
      Number of Owners: ${nft.owners.length}<br>
      Amount: ${nft.amount}
      </p>
    </div>
    `
